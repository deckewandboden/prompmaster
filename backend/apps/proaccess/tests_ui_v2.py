...
class PromptMasterV2RouteIsolationTests(TestCase):
    ...
    def test_free_current_route_adds_v2_shell_but_legacy_route_does_not(self):
        ...
        self.assertIn('/static/js/free_catalog_bridge.20260918.js?v=20260925-mobile15', current_html)
        self.assertIn('/static/js/free_catalog_bridge.20260918.js?v=20260925-mobile15', legacy_html)
        self.assertRegex(
            current_html,
        ...
        self.assertIn('/static/css/promptmaster_v2.20260922.css?v=20260925-mobile15', current_html)
        self.assertIn('/static/js/promptmaster_ui_v2.20260922.js?v=20260925-mobile15', current_html)
        ...
        stripped = current_html.replace(
            '<link rel="stylesheet" href="/static/css/promptmaster_v2.20260922.css?v=20260925-mobile15">',
            '',
        ).replace(
            '<script src="/static/js/promptmaster_ui_v2.20260922.js?v=20260925-mobile15" defer></script>',
            '',
        ).replace(
